...
export default function TextbookCard({ listing }) {
  ...
  return (
    <Link to={`/listings/${listing.id}`}
      className="group block bg-white rounded-2xl border border-gray-50 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-100 transition-all duration-200 p-4 min-w-0 hover:-translate-y-1 active:scale-[0.98]">
