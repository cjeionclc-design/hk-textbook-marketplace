...
export function DetailSkeleton() {
  return (
    <div className="max-w-3xl mx-auto animate-pulse">
      ...
      <div className="bg-white rounded-3xl border border-gray-50 p-6 sm:p-8">
        <div className="flex gap-2 mb-3">
        ...
        <div className="h-5 bg-gray-100 rounded-lg w-40 mb-4" />
